    ...
    () => [
      {
        ...
        content: (
          <StickyScroll
            isDesktop={isDesktop}
            contentItems={WORK_CONTENTS.GROUNDZERO}
          />
        ),
      },
      {
        ...
        content: (
          <StickyScroll
            isDesktop={isDesktop}
            contentItems={WORK_CONTENTS.NVGO}
          />
        ),
      },
      {
        ...
        content: (
          <StickyScroll
            isDesktop={isDesktop}
            contentItems={WORK_CONTENTS.HUNTER}
          />
        ),
      },
    ],
  ...
  return (
    ...
    >
      <img
        ...
        className="absolute hidden left-0 opacity-50 -top-1/4 w-1/12 max-w-xs md:block"
        loading="lazy"
        height={700}
        width={320}
        alt=""
