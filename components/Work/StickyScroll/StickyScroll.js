  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <motion.div
          animate={{
            backgroundImage: `url(${contentItems[activeCard].image})`,
          }}
          className="hidden lg:block h-60 bg-cover bg-center bg-no-repeat w-80 rounded-md bg-white sticky top-10 overflow-hidden"
        >
        </motion.div>
      </motion.div>
    </div>
