...
const Hero = () => {
  ...
  const typedStrings = t('typedStrings', { returnObjects: true });
  ...
  return (
    <section
      ref={sectionRef}
      id={MENULINKS[0].ref}
      className="w-full flex md:items-center max-md:mb-0 py-8 2xl:container mx-auto xl:px-20 md:px-12 px-4 min-h-screen relative mb-24"
      style={{ opacity: 0 }}
    >
      <style global jsx>
        {`
      ...
      <div className="flex flex-col pt-40 md:pt-0 select-none">
        ...
        {t('apresentation')}
          ...
          <span className="staggered-reveal"> Gomes</span>
        </h1>
        <p>
          <span
            ref={typedElementRef}
